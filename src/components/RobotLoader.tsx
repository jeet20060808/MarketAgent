...
const StyledWrapper = styled.div`
  ...
  .eye:first-child {
    ...
    box-shadow: inset 0px 0px 5px #ff5500, 0px 0px 15px 1px #ff8a00;
  ...
  .scannerOrigin {
    ...
    top: 10%;
    background: #ffaa44;
    box-shadow: inset 0px 0px 5px rgba(0, 0, 0, 0.5), 0px 0px 8px #ff8a00;
